...
public static int save(StudentVO bean){
	int status=0;
	try{
...
public static int update(StudentVO bean){
	int status=0;
	try{
		Connection con=DB.getCon();
...
public static List<StudentVO> getAllRecords(){
...
public static List<StudentVO> getDues(){
	List<StudentVO> list=new ArrayList<StudentVO>();
	try{
		Connection con=DB.getCon();
...
public static StudentVO getRecordByRollno(int rollno){
	StudentVO bean=new StudentVO();
	try{
		Connection con=DB.getCon();
